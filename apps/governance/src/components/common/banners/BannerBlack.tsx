...
const BannerBlack = ({ text, href }: { text: string; href: string }) => {
  ...
  return (
    ...
    >
      <div className="mx-4 my-4 flex items-center justify-between rounded-2xl border-4 border-darkGray2 bg-black p-5 font-[GreyCliff] font-bold text-pearl md:mx-0">
        <span>{text}</span>
