...
export const AccountSelector = ({
  ...
  const [selectedWalletTab, setSelectedWalletTab] = useState<WalletTabKey>(
    'WALLET'
  );
  ...
  const activeWalletTab = disableWalletRequest
    ? 'OTHER'
    : selectedWalletTab;
  ...
  const shouldRequestWalletState = activeProviderKey === "keplr" && activeWalletTab === 'WALLET';
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col space-y-3">
      ...
      <div className="space-y-2">
        <TextInput
          placeholder={
            activeWalletTab != 'WALLET' ? inputPlaceholder : ""
          }
          extensionIcon={
