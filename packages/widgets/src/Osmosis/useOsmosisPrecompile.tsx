...
const CXS_CONTRACT = "osmo1a34wxsxjwvtz3ua4hnkh4lv3d4qrgry0fhkasppplphwu5k538tqcyms9x";
const TIMEOUT = 10;
  ...
  async function swap({
    ...
    return await writeContract({
      ...
      request: {
        ...
        args: [[CHANNEL_ID, CXS_CONTRACT, address.evmosAddressEthFormat, input, output, amount, slippage_tolerance, TIMEOUT, address.evmosAddressCosmosFormat]],
        gas: BigInt(1227440),
      },
    });
  }
