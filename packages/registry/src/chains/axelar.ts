...
export default {
  ...
  evmRest: null,
  cosmosGRPC: ["https://axelar-grpc.quantnode.tech:9090"],
  evmRPC: ["https://axelar-grpc.quantnode.tech:9090"],
  tokens: [
    {
    ...
    },
    {
      ...
      ref: "axelar:axlRETH",
      description:
        "Rocket Pool staking derivative rETH for staked ETH on Axelar",
      symbol: "axlRETH",
      denom: "axlRETH",
      sourcePrefix: "axelar",
      sourceDenom: "axlreth",
