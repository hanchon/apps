  ...
  return (
    <>
      <Link rel="noopener noreferrer" target="_blank" href={href}>
        <div className="mt-11 flex w-full items-center justify-center space-x-3 rounded bg-red-300 px-8 py-2 text-lg font-bold uppercase text-pearl hover:bg-red1">
